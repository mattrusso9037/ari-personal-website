...
export const projectsNew: Project[] = [
    ...
    },
    {
        ...
        researchFindings: 'While a structured usability study was not conducted for this particular project, we were able to ask for feedback from users we tasked with testing the original version of the app, which included family and friends. Some feedback we received was that the application was easy to navigate but some functions were unclear. Additionally, some of the colors and font weights used in the original design were difficult to read.',
